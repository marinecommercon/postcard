...
public class FilterListFragment extends Fragment {
	...
	public static FilterListFragment newInstance(EditImageActivity activity) {
	...
	private final class ProcessingImage extends
		...
		protected void onPreExecute() {
			super.onPreExecute();
			dialog = BaseActivity.getLoadingDialog(getActivity(), "Actualisation en cours",
					false);
			dialog.show();
		}
